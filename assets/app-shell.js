...
/* Chỉ trang gửi thuê mới tải mô-đun video. Trang khác không chịu thêm request. */
if (location.pathname.replace(/\/+$/, "") === "/gui-thue") {
  var videoFast = document.createElement("script");
  videoFast.src = "/assets/gui-thue-video-v2.js?v=20260913-2";
  videoFast.async = false;
  document.head.appendChild(videoFast);
}
